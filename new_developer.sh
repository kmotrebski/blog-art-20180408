...
if [ -e .env ]; then
    printf "${RED}.env is already present. Please fill it in the missing configuration (if any at all). If you want to use this configuration helper then you have to delete the .env file and start again. ${NC}\n"
    exit
fi
